...
class BeautyAppointmentStaff(admin.TabularInline):
    model = Appointment
...
class BeautyStaffScheduleSalon(admin.TabularInline):
    model = Schedule
    raw_id_fields = ()
    extra = 0
...
class SalonAdmin(admin.ModelAdmin):
    ...
    list_filter = ()
    raw_id_fields = ()
    inlines = [BeautyAppointmentStaff, BeautyStaffScheduleSalon]
